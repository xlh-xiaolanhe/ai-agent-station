...
import com.xiaolanhe.ai.domain.agent.service.armory.factory.element.RagAnswerAdvisor;
...
/**
 * @author xiaolanhe
 * @description: AutoAgent 测试类<br/>
 * 基于 PlanningAgent 的动态执行机制，实现用户需求的自动化处理
 * @create 2026/1/4 8:43
 */
@Slf4j
...
public class AutoAgentTest {
    ...
    public McpSyncClient stdioMcpClient() {
        var stdioParams = ServerParameters.builder("npx.cmd")
                .args("-y", "@modelcontextprotocol/server-filesystem", "E:/", "E:/Study After Graduate/MyProjectCode/ai-agent-station/ai-agent-station-study-app")
                .build();
