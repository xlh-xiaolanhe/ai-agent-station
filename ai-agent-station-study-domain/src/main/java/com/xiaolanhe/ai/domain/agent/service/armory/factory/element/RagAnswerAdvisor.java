package com.xiaolanhe.ai.domain.agent.service.armory.factory.element;
...
public class RagAnswerAdvisor implements BaseAdvisor {
    ...
    /**
     * 在RAG问答流程结束后，将检索到的文档信息作为元数据附加到最终响应中。
     *
    ...
    protected Filter.Expression doGetFilterExpression(Map<String, Object> context) {
        return context.containsKey("qa_filter_expression")
                && StringUtils.hasText(context.get("qa_filter_expression").toString()) ? (new FilterExpressionTextParser()).parse(context.get("qa_filter_expression").toString()) : this.searchRequest.getFilterExpression();
    }
}
